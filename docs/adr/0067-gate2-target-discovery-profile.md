...
In the paired r7 run, fixed `code-fast` passed 2/30 and routed `code` passed
17/30. Routed class successes were repair 6/10, refactor 2/5, explanation 4/5,
security review 3/5, and scaffold 2/5. First-pass plan acceptance was 0.70,
retrieval recall was 0.9917, precision was 0.8083, provenance was 1.0, and
incorrect edits remained zero. One routed repair request timed out and was
retained as a failed case with conservative budget accounting.

The 17/30 routed result improves on ADR 0066's historical 9/30 routed result,
including its former 0/5 security-review and 0/5 scaffold results. The paired
r7 baseline also regressed from ADR 0066's historical 5/30 to 2/30, so the new
8.5 success ratio must not be presented as evidence of general model stability.
