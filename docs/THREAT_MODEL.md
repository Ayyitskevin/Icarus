...
## Accepted fifth M3 verification-attempt design threats
...
ADR 0018 is accepted design only. It preserves the loopback/same-origin/CSP
boundary, guarded CLI authority, and independent ADR 0010 release hold.
