...
| [0029](adr/0029-browser-approval-authority.md) | Fresh-origin browser mutation session and fenced Linux run actions | Accepted — origin portability is held by candidate ADR 0040 |
...
| [0040](adr/0040-chromium-resolved-localhost-origins.md) | Chromium-resolved 128-bit `.localhost` mutation origins over exact `127.0.0.1` | Candidate — implementation and exact-head native real Chrome acceptance pending |
