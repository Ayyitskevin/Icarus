...
| [0026](adr/0026-agent-session-loop-and-tool-registry.md) | AgentSession loop, host-owned tool registry, and manifest-bound capability grants | Proposed — awaiting operator decision on slicing and iteration ceiling |
