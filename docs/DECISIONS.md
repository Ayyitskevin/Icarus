...
| [0036](adr/0036-proof-carrying-software-factory-product-direction.md) | Proof-carrying software factory product direction and gated competitive roadmap | Accepted product direction — Gate 0 release head `802b91e6`; Gate 1 active with PR #20 foundations and PR #22's browser-authority slice published, while durable landing, landing/PR receipts, and credential-gated live evidence remain open |
