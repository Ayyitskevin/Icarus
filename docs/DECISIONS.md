...
| [0026](adr/0026-agent-session-loop-and-tool-registry.md) | AgentSession loop, host-owned tool registry, and manifest-bound capability grants | Accepted — 2a, the ADR 0024 supersession, and the full tool surface landed; the loop and browser approvals outstanding |
