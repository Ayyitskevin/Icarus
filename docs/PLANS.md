...
- [x] Execute five host-policy-compatible repair cases through the same production lifecycle.
...
- [ ] Raise stable routed quality from 19/30 (manifest v3, revision 10, 2026-09-02) to at least 24/30 while
      ...
      that vary something (a declared temperature or seed — temperature-0 runs replicate),
