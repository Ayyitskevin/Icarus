...
export class IcarusService {
  ...
  constructor(options: IcarusServiceOptions) {
    ...
    this.#landing = new LandingCoordinator({
      ...
      store: this.#store,
      leases: this.#leases,
      ...(options.landingGit === undefined ? {} : { landingGit: options.landingGit }),
      ...(options.landingCredentialEnvironmentNames === undefined
        ? {}
        : { landingCredentialEnvironmentNames: options.landingCredentialEnvironmentNames }),
      ...(options.landingGithubGateway === undefined
        ? {}
        : { landingGithubGateway: options.landingGithubGateway }),
      ...(options.landingCredentialEnvironment === undefined
        ? {}
        : { landingCredentialEnvironment: options.landingCredentialEnvironment }),
      now: this.#now,
  ...
  async decideLanding(
    ...
    return this.#landing.decideLanding(runId, landingSha256, actor, decision);
  }

  async resumeLanding(runId: string, signal?: AbortSignal): Promise<LandingStatusV1> {
    return this.#landing.resumeLanding(runId, signal);
  }
